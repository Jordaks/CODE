...
void LinearSearch(int arr[], int size, int key){
    for(int i = 0; i < size; i++){
        if(key == arr[i]){
            cout << "The key element found at index: " << i;
            return;
        }
    }
    cout << "The key element not found in array";
}
...
void JumpSearch(int arr[], int size, int key){
    ...
    if (arr[prev] == key) {
        cout << "The key element found at index: " << prev;
        return;
    }
...
void ExponentialSearch(int arr[], int key, int size) {
    if (arr[0] == key) {
        cout << "The key element found at index: 0";
        return;
    }
